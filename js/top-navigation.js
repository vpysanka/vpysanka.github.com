...
//         mega_panel(mega, catalog, cart_menu, cart);
//     });

//     cart.on('click', function() {
//         cart_panel(cart_menu, cart, mega, catalog);
//     });
// });
...
// function cart_panel(cart_menu, cart, mega, catalog) {
//     if (cart_menu.hasClass('active')) {
//         cart_menu.removeClass('active');
//         cart.removeClass('active');
//     } else {
